...
// Placeholder replacements (sesuaikan dengan template)
$replacements = [
    '{{SPT_NO}}' => $data['spt_no'],
    ...
    // SPD Parts (tambahkan di template HTML posisi ini, contoh di <td> nama dll.)
    // Misal di tabel SPD: ganti teks statis dengan placeholder
    // Contoh: Nama yang melaksanakan -> {{SPD_NAMA}}
    '{{SPD_NAMA}}' => $data['nama_pegawai'],  // Tambahkan di HTML: <td>{{SPD_NAMA}}</td>
    '{{SPD_PANGKAT}}' => $data['pangkat'] ?? ' - ',
    '{{SPD_JABATAN_SPD}}' => $data['jabatan'],  // b. Jabatan
    ...
    '{{SPD_PENGIKUT_NAMA}}' => $data['pengikut'] ?? ' - ',  // Jika multiple, format list
    '{{SPD_INSTANSI}}' => $data['instansi_anggaran'],
    '{{SPD_AKUN}}' => $data['akun_anggaran'] ?? ' - ',
    '{{SPD_NO}}' => $data['spd_no'],
    '{{TGL_SPD}}' => date('d F Y', strtotime($data['tanggal_berangkat']))
    // Tambahkan lebih untuk bagian I-V jika dinamis, saat ini statis
];

// Template surat lengkap sebagai string (copy HTML Anda, tambah placeholder di posisi dinamis)
...
<div class="document-container">
    <div class="header-section">
        <img class="logo" src="../pegawai/logo.png" alt="Lambang Kabupaten Banggai Kepulauan">
    ...
    <p>Demikian Surat Tugas ini dibuat dan diberikan kepada yang bersangkutan untuk dilaksanakan sebagaimana mestinya.
    </p>
    ...
    <div class="document-container">
        ...
        <div style="text-align: left; font-size: 11pt; margin-bottom: 5px;">
            ...
            <p style="float: right; margin: 0;">Lembar ke&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </p>
        ...
        <div style="text-align: left; font-size: 11pt; margin-bottom: 5px;">
            ...
            <p style="float: right; margin: 0;">Kode
                No&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </p>
            <div style="clear: both;"></div>
        </div>
        <div style="text-align: left; font-size: 11pt; margin-bottom: 5px;"></div>
        ...
        <tr>
            <div class="spt-signature-block">
                <div class="spt-signer">
                    ...
                    <p class="spt-signer-date">PADA TANGGAL : {{TGL_TERBIT}}</p>
                    <p>DEWAN PERWAKILAN RAKYAT DAERAH</p>
                    <p>KABUPATEN BANGGAI KEPULAUAN</p>
                    <p style="margin-top: 100px; font-weight: bold; text-decoration: underline; margin:100">ARKAM SUTU,
                        S.Th.,IM.H
                    </p>
                </div>
            </div>
        </tr>
        <!-- BAGIAN I – V SAMA PERSIS DENGAN GAMBAR -->
        <table
            style="width:100%; border-collapse:collapse; font-family:Times New Roman, serif; font-size:12pt; margin-top:10px;">
            <tr>
            ...
            <tr>
                ...
                <td style="border:1px solid #000; padding:6px; vertical-align:top;">
                    ...
                    kepentingan jabatannya dalam waktu yang sesingkat-singkatnya.<br><br>
                    <div style="text-align:center; font-weight:bold;">
                        Plt. Sekretaris DPRD<br>
                        Kabupaten Banggai Kepulauan<br><br><br><br>
                        ASGAR LALU, SH<br>
            ...
            <tr>
                <td colspan="2" style="border:1px solid #000; padding:6px; vertical-align:top;">
                    ...
                    Kepala SKPD yang menerbitkan SPD, Pegawai yang melakukan perjalanan dinas, para Pejabat yang
