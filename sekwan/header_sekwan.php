...
<body>
    <header
        style="background:#6c757d;color:white;padding:10px; display:flex; justify-content:space-between; align-items:center;">
        ...
        <nav>
            <a href="sekwan_dashboard.php" style="color:white; margin-right:10px;">Dashboard</a>
